...
class LFData(object):
    ...
    -------
    load_mats(mat_files)
        Load 4 .mat files into LFData
    load_dicts(data_dicts)
        Load 4 dictionaries generated by load_rx_data into LFData
    combine_data(data_dicts)
        Combine a set of amplitude-phase data into a single object
    rotate_data(correction_val=0.0)
        Calculate the radial and azimuthal components of B-field
